<template>
	<div>
		...
		<section v-for="(que, qindex) in newContent" class="main">
			<div class="ques">
		...
		<section>
			<div>
				<button @click="releaseQues(newData)" class="relbtn"><router-link to="/list">发布问卷</router-link></button>
				<button @click="saveQues(newData)" class="savebtn"><router-link to="/list">保存问卷</router-link></button>
			</div>
		</section>
